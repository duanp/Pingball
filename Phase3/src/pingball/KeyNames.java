...
/**
 * An immutable class (skeleton provided by 6.005 staff) to translate key codes to
 * English expressions of the keys.
 *
 */
public class KeyNames {
    
    // a map containing keycode --> key
    ...
    /**
     * Gets the key stroke corresponding to the key code.
     * @param keycode the key code
     * @return the key stroke
     */
    public String getKey(int keycode) {
        return keyName.get(keycode);
    }
